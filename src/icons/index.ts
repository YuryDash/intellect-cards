...
export { ImageIcon } from './icon-components/image-icon'
...
export { RatingFullStarIcon } from './icon-components/rating-full-star-icon'
export { RatingStarIcon } from './icon-components/rating-star-icon'
