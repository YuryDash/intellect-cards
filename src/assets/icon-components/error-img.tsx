...
export function ErrorImg(fullProps: IconProps) {
    ...
    <IconWrapper
      icon={
        ...
        >
          ...
          <path
            fill="#A280FF"
            d="M137.7 124.7l62.4-41.2 5-3.3-3.3-5-10.5-15.9-1.7-2.6-3.1-.1-101.3-2.7-1.9-.1-1.6 1-9.7 6.4-5 3.3 3.3 5 30 45.4-24.5 16.2-5 3.3 3.3 5 9.2 13.9 3.3 5 5-3.3 24.5-16.2 6.7 10.2 3.3 5 5-3.3 11.5-7.6 5-3.3-3.3-5-6.6-10.1zm-29.6-44.9l42.9 1.7-29.1 19.2-13.8-20.9z"
          ></path>
          <path
            fill="#B0BEC5"
          ...
          ></path>
          <path fill="#37474F" d="M28.127 113.194l-7.5.014.147 78.8 7.5-.014-.148-78.8z"></path>
          <path
            fill="#37474F"
            d="M15.3 188.7v.9c0 1.3 1.1 2.4 2.4 2.4h13.8c1.3 0 2.4-1.1 2.4-2.4v-.9H15.3z"
          ></path>
          <path fill="#455A64" d="M28.4 185.1h-7.6l-5.5 3.6H34l-5.6-3.6z"></path>
          <path
            fill="url(#paint7_linear_2_5413)"
            d="M28.4 185.1l-.2-71.9h-2.8l.2 71.9 2.7 3.6v.9c0 1.3-1.1 2.4-2.4 2.4h5.7c1.3 0 2.4-1.1 2.4-2.4v-.9l-5.6-3.6z"
          ></path>
          <path
            fill="#E53935"
          ...
          ></path>
          <path fill="#37474F" d="M444.23 115.594l-7.3.013.142 75.7 7.3-.014-.142-75.699z"></path>
          <path
            fill="#37474F"
            d="M431.6 188v.8c0 1.3 1.1 2.4 2.4 2.4h13.4c1.3 0 2.4-1.1 2.4-2.4v-.8h-18.2z"
          ></path>
          <path fill="#455A64" d="M444.4 184.5H437l-5.4 3.5h18.2l-5.4-3.5z"></path>
          <path
            fill="url(#paint9_linear_2_5413)"
            d="M444.4 184.5l-.2-68.9h-2.7l.2 68.9 2.6 3.5v.8c0 1.3-1.1 2.4-2.4 2.4h5.5c1.3 0 2.4-1.1 2.4-2.4v-.8l-5.4-3.5z"
          ></path>
          <path
            fill="#E53935"
          ...
          <path
            fill="#F5D100"
            d="M450.885 115.593l-436.8.815.031 16.5 436.8-.815-.031-16.5z"
          ></path>
          <path
            fill="#263238"
          ...
          <path
            ...
            d="M14.1 132.9l436.9-.8-.1-8.4-436.8.8v8.4z"
          ></path>
          <defs>
            <linearGradient
            ...
            >
              ...
              <stop offset="1" stopColor="#D6D7F4"></stop>
            </linearGradient>
            <linearGradient
