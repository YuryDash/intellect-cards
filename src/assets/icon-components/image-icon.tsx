export function ImageIcon() {
  return (
    ...
    >
      <g clipPath={'url(#clip0_15187_6036)'} fill={'#fff'}>
        <path
          d={
        ...
        ></path>
        <path d={'M5.833 6.667a1 1 0 100-2 1 1 0 000 2z'}></path>
      </g>
      <defs>
        <clipPath id={'clip0_15187_6036'}>
          <path d={'M0 0H16V16H0z'} fill={'currentColor'} transform={'translate(.5)'}></path>
        </clipPath>
      </defs>
    </svg>
  )
